    ...
    <section className="w-full flex justify-center px-4">
      <div className="max-w-3xl space-y-6">
        ...
        <p className="leading-relaxed">
          ...
          publicación pasa por un proceso de selección donde evaluamos el
          modelo, su relevancia, su rareza y el nivel de interés que puede
          generar en nuestra comunidad. Nuestro objetivo es mantener un catálogo{" "}
        ...
        <p className="leading-relaxed">
          ...
          exposición de alto nivel a los vendedores. Cada instrumento pertenece
          a su dueño original, quien es el{" "}
          <strong>único responsable del estado y veracidad</strong> del
          producto. Las transacciones se coordinan directamente entre comprador
          y vendedor.
        </p>
